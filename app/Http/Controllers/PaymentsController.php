...
class PaymentsController extends Controller
{
    ...
    public function pay(Request $request){
        ...
        $redirectLinks = array_values($redirectLinks);//eliminar los nulos
    ...
    public function execute(Request $request){
          ...
          if($response->statusCode ==200){
            ...
            if($order){
                ...
                return view('payments.success',compact('order','shopping_cart'));

            }
          }else{
            return redirec(URL::route('shopping_cart.show'));
          }
        }
}
